...
urlpatterns = [
    ...
    path('fila/<int:queue_id>/join/', join_queue, name='join_queue'),
    path('fila/<int:student_id>/check_position/', check_position, name='check_position'),
    path('fila/<int:queue_id>/leave/', leave_queue, name='leave_queue'),
